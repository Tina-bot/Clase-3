document.addEventListener("DOMContentLoaded", () => {
    const navContent = `
    <span class="icon">
            <svg id="logo-78" width="175" height="40" viewBox="0 0 175 40" fill="none"
...
<i class="fa-solid fa-wallet"></i>
          ...
          <li>
              <a href="./pages/detailscompany.html">
                <i class="fa-solid fa-building"></i>  Mi Empresa
              </a>
          </li>
          <li>
              <a href="./pages/analyticsreport.html">
<i class="fa-solid fa-chart-pie"></i> Analiticas
              </a>
          </li>
      </ul>
      <div class="nav-bottom">
          ...
          <div class="menu-item">
              <span class="icon">🚪</span>
              <a href="./pages/404.html">Cerrar Sesión</a>
          </div>
          <div class="menu-item">
              <span class="icon">📝</span>
            ...
            <div class="container-fluid">
                ...
                <div class="ms-auto d-flex align-items-center gap-2">
                    <div class="position-relative">
                        <a class="text-white inline-style-0" href="#">
                            <i class="fa-solid fa-folder inline-style-1">
                            </i>
                        </a>
                    </div>
                    <div class="position-relative">
                        <a class="text-white inline-style-2" href="#">
                            <i class="fa-solid fa-calendar-days inline-style-3">
                            </i>
                            <span
                                class="position-absolute top-2 start-100 translate-middle badge rounded-pill badge-primary inline-style-4">
                                5
                    ...
                    <div class="position-relative">
                        <a class="text-dark inline-style-5" href="#">
                            <i class="fas fa-bell fa-lg">
                            </i>
                            <span
                                class="position-absolute top-2 start-100 translate-middle badge rounded-pill badge-primary inline-style-6">
                                3
                                <span class="visually-hidden">
                ...
                <div class="dropdown ms-4">
                    <button aria-expanded="false" class="btn dropdown-toggle d-flex align-items-center gap-2"
                        data-bs-toggle="dropdown" type="button">
                        <div
                            class="d-flex align-items-center justify-content-center rounded-circle bg-secondary bg-opacity-25 inline-style-7">
                            <i class="fas fa-user text-dark">
                            </i>
                        </div>
                    </button>
